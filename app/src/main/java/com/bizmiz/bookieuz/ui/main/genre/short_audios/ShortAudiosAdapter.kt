...
import com.bizmiz.bookieuz.databinding.ShortAudiosItemBinding
import com.bizmiz.bookieuz.databinding.UzbBookItemBinding
import com.bizmiz.bookieuz.ui.model.DataXX
import com.bumptech.glide.Glide

class ShortAudiosAdapter : RecyclerView.Adapter<ShortAudiosAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: ShortAudiosItemBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val shortAudiosItemBinding =
            ShortAudiosItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ViewHolder(shortAudiosItemBinding)
    }
